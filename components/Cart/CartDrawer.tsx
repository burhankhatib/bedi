...
import { X, Plus, Minus, ShoppingCart, QrCode, MessageCircle, Edit2, RotateCcw, Trash2, Send, LogOut } from 'lucide-react'
                        ...
                        <>
                          ...
                          {totalItems > 0 && (
                            <Button
                              ...
                              variant="outline"
                              className="w-full h-11 rounded-xl font-bold border-2 border-red-200 text-red-700 hover:bg-red-50 hover:border-red-300 mt-2"
                            >
                              <LogOut className="w-4 h-4 mr-2" />
