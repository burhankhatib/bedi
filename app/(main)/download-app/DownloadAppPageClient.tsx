...
const PWA_APPS: PwaItem[] = [
  ...
  },
  {
    ...
    name: 'Bedi Business',
    nameAr: 'بيدي للأعمال',
    description: 'One app for all your businesses. New order and update notifications for every location.',
    descriptionAr: 'تطبيق واحد لجميع أعمالك. إشعارات الطلبات الجديدة والتحديثات لكل موقع.',
    icon: '/adminslogo.webp',
    installUrl: '/dashboard',
    installHint: 'Open the dashboard (sign in first), then install from the browser menu.',
    installHintAr: 'افتح لوحة التحكم بعد تسجيل الدخول، ثم ثبّت من قائمة المتصفح.',
    note: 'This is only for users who registered for free as a tenant. Start your store today for free without any hidden or extra fees.',
    noteAr: 'هذا فقط للمستخدمين المسجلين مجاناً كمتاجر. ابدأ متجرك اليوم مجاناً بدون رسوم خفية أو إضافية.',
  },
  {
    id: 'per-business',
    name: 'Business orders app',
    nameAr: 'تطبيق طلبات الأعمال',
    description: 'One PWA per business with your logo. Notifications only for that business\'s orders.',
    descriptionAr: 'تطبيق ويب مستقل لكل عمل مع شعارك. إشعارات لطلبات هذا العمل فقط.',
    icon: '/adminslogo.webp',
    installUrl: '/dashboard',
    installHint: 'Go to your business dashboard, open the Orders page, then install from there.',
    installHintAr: 'انتقل إلى لوحة تحكم عملك، افتح صفحة الطلبات، ثم ثبّت من هناك.',
    note: 'This is only for users who registered for free as a tenant. Start your store today for free without any hidden or extra fees.',
    noteAr: 'هذا فقط للمستخدمين المسجلين مجاناً كمتاجر. ابدأ متجرك اليوم مجاناً بدون رسوم خفية أو إضافية.',
  },
]
