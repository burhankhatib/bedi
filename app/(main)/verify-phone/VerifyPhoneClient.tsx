          ...
          <>
            <div className="mb-4">
              <p className="text-sm text-slate-600 mb-1">
                {t('Enter the 6-digit code we sent to', 'أدخل الرمز المكوّن من 6 أرقام الذي أرسلناه إلى')} <span className="font-mono font-medium" dir="ltr">{ensureE164(phoneInput, countryCode)}</span>
              </p>
            </div>
            <Input
              type="text"
