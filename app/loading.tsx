...
const loadingMessages = [
  {
    en: "Our chef is preparing something amazing... 👨‍🍳",
    ar: "الشيف يعد شيئاً رائعاً... 👨‍🍳"
  },
  {
    en: "Fresh ingredients loading... 🥬",
    ar: "جارٍ تحميل المكونات الطازجة... 🥬"
  },
  {
    en: "The chicken is still cooking... 🍗",
    ar: "الدجاج لا يزال يطبخ... 🍗"
  },
  {
    en: "Almost ready! Our menu is worth the wait! ⏳",
    ar: "تقريباً جاهز! قائمتنا تستحق الانتظار! ⏳"
  },
  {
    en: "Loading deliciousness... 🍽️",
    ar: "جارٍ تحميل اللذة... 🍽️"
  },
  {
    en: "Preparing your perfect meal... ✨",
    ar: "جارٍ إعداد وجبتك المثالية... ✨"
  }
]

export default async function Loading() {
  // Use generic app logo; tenant routes use (main)/t/[slug]/loading.tsx with that business's logo
