...
/**
 * Customer PWA manifest. Served at /manifest.json via rewrite.
 * Requires id + application/manifest+json so Chrome treats the app as installable (not just "add shortcut").
 */
